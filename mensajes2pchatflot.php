                ...
                echo "<table>";
                    echo "<tr bgcolor='#AED6F1'>";
                        if ($almorzando=='si') {
                            ...
                            <td bgcolor='#AED6F1'><strong>🔴</strong> En el momento no esta disponible, esta almorzando</td>
                            ";
                        }
                        else
                        {
                            ...
                            <td  bgcolor='#AED6F1'><strong>🟢</strong> Disponible</td>
                        ...
                        if ($foto!='') 
                        {
                            echo "<td bgcolor='#AED6F1'><img src='imgUsuarios/".$foto."' alt='' class='img-avatar' alt='' class='img-avatar m-r-10'></td>";
                        }
                        else
                        {

                            echo "
                            <td bgcolor='#AED6F1'><img src='imgUsuarios/userd.jpg' alt='' class='img-avatar' alt='' class='img-avatar m-r-10'>
                            </td>"; 
                        }
                            ...
                            <td bgcolor='#AED6F1'><a href='chatflotante.php' target='iframechat' class='btn btn-default'><span class='glyphicon glyphicon-circle-arrow-left'></span>Volver</a>  </td>                     
                    ...
                    echo "<tr>";
                        echo"<td colspan='4'>";
                        echo"<div class='ms-body1'  >";
                            echo"<div class='pull-left hidden-xs' id = 'aqui'>";
                                     echo" </div>";
                           echo" <ul class='ah-actions actions'>
                            </div>";
                        // caja de mensajes     style=' overflow: scroll;'   
                        echo "<div class='message_template' id ='caja' style='overflow: scroll; height: 130px; width: 100%;' ></div>"; 
                        echo "</div>";
                    ...
                    <tr>
                            ...
                            <td><input type='file' style='display:none;' id='idFiles' class='form-control' name='file' value='selecciona archivo' multiple>
                            
                           
            
            
                            <td><label for='file-input' class='file-label'><i class='fa fa-upload'></i> Upload File</label></td>
                            <td><input type='text' spellcheck='true' class='form-control' name='mensajetexto' placeholder='nombre'></td>
                            <td><input type='hidden' class='form-control'  name='de' size='20' value='".$idUserA."'></td>
                            <td><input type='hidden' class='form-control'  name='para' size='20' value='".$iduChat."'></td>
                            <td><input  type='hidden' class='form-control'  name='nrespuestas' id='nrespuestas'  size='20' value=''></td>
                            
                            
                            <td><button type='submit'  id='enviar'  class='btn btn-primary btn-block' name='enviar' onclick='miFunc()' >Enviar</button></td>
...
$('.file-label').click(function() {
  $('#idFiles').trigger('click');
});
// const input = document.getElementById('idFiles');
//   const icon = document.querySelector('images/subimag.png');
