...
$FB->llena_texto("id_param2", 1, 13, $DB, "", "", $id_param, 5, 0);
	...
	$FB->llena_texto("Metodo de Pago:",6,2, $DB, "(SELECT * from tipospagos where pag_estado like '%Activo%' order by idtipospagos )", "", "1", 1, 1);
...
if($cambio==1){
	$FB->llena_texto("¿Paquete Recogido?:",1,82, $DB, $recogido1, "cambio_ajax2(this.value, 11, \"llega_sub1\",1, 1,$id_param)",@$rw[1], 17, 1);

}else{
	$FB->llena_texto("¿Paquete Recogido?:",1,82, $DB, $recogido, "cambio_ajax2(this.value, 11, \"llega_sub1\",0, 1,$id_param)",@$rw[1], 17, 1);
