...
<?php
                ...
                $compañero="SELECT idusuarios, usu_nombre  FROM usuarios where idusuarios='$id_usuario'";
                $DB1->Execute($compañero); 
                $nom=mysqli_fetch_row($DB1->Consulta_ID);
                $nombre=$nom[1];
        ...
        <div class="uno">
            ...
            <table class="table table-hover">
                <tr bgcolor="#074F91" class="tittle3">
                    ...
                    <td colspan=2 align='center'>Enrutamiento De <?php echo$nombre;?></td>
                </tr>
