	...
	case "Agregar conductor":
		...
		if (is_uploaded_file($_FILES['param5']['tmp_name'])){
		 ...
		 if (is_uploaded_file($_FILES['param9']['tmp_name'])){
			...
			$sql="INSERT INTO `conductor_mani`( `cond_nombre`, `cond_celular`, `cond_whatsapp`, `cond_cedula`, `cond_foto_celula`, `cond_num_licen`, `cond_foto_licen`, `cond_foto_conductor`, `cond_firma`, `cond_lugar_expedi`) VALUES ('$param1','$param2','$param3','$param4','$imagen1','$param6','$imagen2','$imagen3','$imagen4','$param30')";
...
case "Editar conductor":
	$conductor = "SELECT  `cond_foto_celula`, `cond_foto_licen`, `cond_foto_conductor`, `cond_firma` FROM `conductor_mani` where condid=$id_param ";
    $DB1->Execute($conductor);
    $rw2 = mysqli_fetch_array($DB1->Consulta_ID);
	...
	if (is_uploaded_file($_FILES['param5']['tmp_name'])){
	 ...
	 if (is_uploaded_file($_FILES['param9']['tmp_name'])){
		...
		$sql="UPDATE `conductor_mani` SET `cond_nombre`='$param1',`cond_celular`='$param2',`cond_whatsapp`='$param3',`cond_cedula`='$param4',`cond_foto_celula`='$imagen1',`cond_num_licen`='$param6',`cond_foto_licen`='$imagen2',`cond_foto_conductor`='$imagen3',`cond_firma`='$imagen4', `cond_lugar_expedi`='$param30' WHERE condid='$id_param' ";

		$valores[7]=$sql; $valores[4]="adm_manifiestos.php"; $valores[8]=1; 
		
break;
case "Editar viaje":
    $conductor = "SELECT `mani_manifiesto`,mani_remesa_carga,mani_guias FROM `manifiestos_viajes` WHERE  idmani=$id_param ";
    $DB1->Execute($conductor);
    $rw2 = mysqli_fetch_array($DB1->Consulta_ID);
