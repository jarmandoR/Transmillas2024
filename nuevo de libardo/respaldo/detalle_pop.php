 ...
 FROM `guias` WHERE  `gui_idservicio`=$id_param";
    ...
    <div class="modal-body"><div class="form-group">
        ...
        $FB->titulo_azul1(" $sumatotal", 1, 0, 0);
          ...
          echo  $sql="SELECT `idhojadevida`,`hoj_nit`,`hoj_cedula`,`hoj_razonsocial`,`hoj_telefono1`, `hoj_telefono2`,   `hoj_email`, `hoj_direccionrf`, `hoj_fechanaradicacion`, `hoj_fechanacorte`, `hoj_numerocuenta`, `hoj_plazopago`, `hoj_novedadesfactura` FROM `hojadevidacliente` left join creditos on idcreditos=hoj_clientecredito where cre_nombre='$id_param' ORDER BY  hoj_nombre asc ";
