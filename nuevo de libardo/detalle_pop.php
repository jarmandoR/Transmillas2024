 ...
 FROM `guias` WHERE  `gui_idservicio`=$id_param";
    ...
    <div class="modal-body"><div class="form-group">
        ...
        $fechaactual = date("Y-m-d");
         ...
         $FB->llena_texto("Carpeta:", 1, 2, $DB, "(SELECT `idcarpeta`,`car_nombre` FROM `carpetasTransmillas`)", "cambio_ajax2(this.value, 100, \"llega_sub1\", \"param33\", 1, $idciudad)", "", 17, 1);
        ...
        $sql="SELECT `doctid`, `doct_nombre`, `doct_id_carpeta`, `doct_archivo`, `doct_fechavence` FROM `documentosTransmillas` WHERE doct_id_carpeta='$id_param'";
