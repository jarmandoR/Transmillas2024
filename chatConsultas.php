...
$fechadosdias=date("Y-m-d H:i:s",strtotime($fecha_actual."- 1 days")); 
  ...
  $sql="SELECT idnoticia,  not_fecha,  usu_usuario, not_titulo, not_descripcion, not_expiracion,not_idrol,not_visto,not_respuesta,not_imagen , roles_idroles, not_idusuario, usu_nombre, not_userinsert,not_idDe, not_fechaVisto,not_idrespuestaespesifi FROM noticia left join usuarios on idusuarios=not_idusuario where idnoticia>1 and not_fecha>=date('$fechadosdias') $conde4   ORDER BY 1 asc";
 // echo "$id_nombre";
$DB->Execute($sql); $va=0; 
           ...
           echo "<div class='message-feed media'>
                ...
                <li class='dropdown'>
                        ...
                        <ul class='dropdown-menu dropdown-menu-right'>
                            <li>
                                <a href='mensajes.php?idUserm=$iduChat&menres=$rw1[0]&varVisto=si'>Responder</a>
                            </li>
