...
cue_idservicio,cue_validadoentrega,cue_idoperpendiente,cue_fechapcobrar,cue_estado,cue_transferencia,ser_numerofactura,ser_pendientecobrar,`ser_confimgrec`,`ser_confimgentre`
	...
	if($impri==1){
		...
		if($rw2[15]>$prestamo and $rw2[19]==$param2){  //$rw2[19]=entregas
			...
			if($cue_idoperador==$param2){
				...
				$sqlrecogida="SELECT ima_ruta,ima_tipo,idimagenguias from imagenguias where ima_tipo ='Recogida' and  ima_idservicio=$id_p ";
