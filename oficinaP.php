<script>
	function cam2(valor, valor2,valor3,valor4)
{
...
$FB->llena_texto("Ciudad Origen:",4,2,$DB,"(SELECT `idciudades`, `ciu_nombre` FROM `ciudades`  where inner_estados=1)", "cam2(this.value,param11.value,\"campo \",\"oficina\");", "$param4", 4, 1);
...
$FB->llena_texto("Ciudad Destino:",11,2,$DB,"(SELECT `idciudades`, `ciu_nombre` FROM `ciudades`  where inner_estados=1 )","cam2(param4.value,this.value,\"campo\",\"oficina\");","$rw[11]",4,1);
...
echo"<td style='background-color: #F5B7B1;'>Tipo de servicio</td><td id='respuesta'></td>";
