...
$efectivase1=0;
	...
	while($rw1=mysqli_fetch_row($DB->Consulta_ID))
	{
		...
		// echo $idestadoguia="SELECT  seg_idservicio,seg_direccion   FROM seguimientoruta where seg_fecha >= '2023-09-28 00:00:00' and (`seg_idusuario`='$id_p'  and seg_estado!='Cambioruta') order by `seg_fechaestado` desc limit 1";
	...
	// remesas
			...
			echo "<td bgcolor='$color23'>".$minutos." Minutos</td>";
