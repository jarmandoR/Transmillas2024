...
function llena_datos(ex, nivel, ordby, asc)
{
	...
	if(ex==1){
		...
		destino="detalle_cuentasespecificas.php?param31="+p1+"&param32="+p2+"&param33="+p3+"&param34="+p4+"&param35="+p5+"&param36="+p6+"&param37="+p7+"&param38="+p8+"&param40="+p9+"&param41="+p10+"&accion=actualizar";
	...
	//	destino1="actualizarcampos.php?param31="+p1+"&param32="+p2+"&param33="+p3+"&param34="+p4+"&param35="+p5+"&param36="+p6+"&param37="+p7+"&param38="+p8+"&param40="+p9+"&param41="+p10+"&pagina="+pagina+"&ordby="+ordby+"&asc="+asc;
			...
			destino="detalle_cuentasespecificas.php?param31="+p1+"&param32="+p2+"&param33="+p3+"&param34="+p4+"&param35="+p5+"&param36="+p6+"&param37="+p7+"&param38="+p8;
			MostrarConsulta4(destino, "destino_vesr")
...
$FB->llena_texto("Manifiesto:", 40, 1, $DB, "", "","$param40", 1,0);
$FB->llena_texto("Codigo:", 41, 1, $DB, "", "","$param41", 4,0);

echo "<tr><td><button type='button' class='btn btn-info' onclick='llena_datos(2, $nivel_acceso, \"id_nombre\", \"ASC\");'>Guardar</button></td></tr>";
