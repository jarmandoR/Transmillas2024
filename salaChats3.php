    ...
    echo "<ul class='ah-actions actions'>
                    ...
                    <a href='usersChat.php' class='btn btn-default'><span class='glyphicon glyphicon-plus-sign'></span>nuevo chat</a>
                        ...
                        <ul class='dropdown-menu dropdown-menu-right'>
                            <li>
                                <a href='usersChat3.php'>Latest</a>
                 ...
                 <li class='dropdown'>
                        ...
                        <button type='button' id='autorizar' class='btn btn-default'>Autorizar Notificaciones</button>
                          ...
                          <a href='salaChats.php' ><mark>Si tiene dificultad para subir las imagenes de click aqui, estamos trabajando para mejorar este modulo.</mark>
...
// Trae los numeros de mesajes.
 ...
 $sql1 = "SELECT count(*) FROM `noticia` WHERE not_idusuario='$idUserA' AND not_idDe='$rw[1]'and not_visto='no' AND not_deChat=''";
 $DB1->Execute($sql1); 
...
$almorzando=$DB_m->recogedato(0);
                ...
                <a class='list-group-item media' target='_top' href='mensajes2p.php?idUserm=".$rw[1]."&varVisto=si'>
                <div class='pull-left'>
                ";
              if ($foto!='') {
