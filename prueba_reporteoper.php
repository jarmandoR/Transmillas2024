...
//	p1=document.getElementById('param31').value;
	...
	if(ex==1){
		...
		destino="prueba_reporoper.php?param31="+p1+"&param32="+p2+"&param33="+p3+"&param34="+p4+"&param35="+p5+"&param37="+p7+"&pagina="+pagina+"&ordby="+ordby+"&asc="+asc;
...
if($nivel_acceso==1 or $nivel_acceso==12){
$FB->llena_texto("Fecha de Final:", 32, 10, $DB, "", "", "$fechaactual", 1, 0);
}else{
